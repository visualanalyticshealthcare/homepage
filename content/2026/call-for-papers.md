...
The 2026 Workshop on Visual Analytics in Healthcare will cover a range of topics on the design, implementation, deployment, evaluation, and abstraction of visual analytics methods, including (but not limited to):
...
- Short papers (in "4+A+1" IEEE format or AMIA format)
    - **Research**
    - **Application**
  
- Doctoral consortium (in "2+1" IEEE format or AMIA format)
    - **Doctoral consortium**: focuses on preliminary results related to visual analytics

- Abstracts (in "2+1" IEEE format or AMIA format)
...
All material will be submitted via [EasyChair](https://easychair.org/conferences/?conf=vahc2026).

Submission Templates:

- IEEE VGTC conference format: 
[https://tc.computer.org/vgtc/publications/conference/](https://tc.computer.org/vgtc/publications/conference/) 
- AMIA format: [https://amia.org/education-events/amia-2026-annual-symposium/call-participation](https://amia.org/education-events/amia-2026-annual-symposium/call-participation)


Contact [swaminathan.kandaswamy@emory.edu](mailto:swaminathan.kandaswamy@emory.edu) or [he.huan@mayo.edu](mailto:he.huan@mayo.edu) if you have any questions.
